...
SUBSCRIBE_NODES = [
    ...
    {   
        ...
        # "browse_path": ["0:Objects", f"2:PLC", f"2:read_conveyor_sensor_check"],
        "browse_path": "ns=2;s=read_conveyor_sensor_check",
    ...
    #로봇암 센서 체크 - AMR : write_amr_go_move("pick_up_zone"), ARM : write_arm_go_move("go_home")
    {
        ...
        # "browse_path": ["0:Objects", f"2:PLC", f"2:read_robotarm_sensor_check"],
        "browse_path": "ns=2;s=read_robotarm_sensor_check",
    ...
    {
        "name": "send_arm_json",
        # "browse_path": ["0:Objects", f"2:ARM", f"2:read_send_arm_img"],
        "browse_path": "ns=2;s=read_send_arm_json",
        "webhook": "/api/v1/arm/send_arm_json",
    },
    # # Place 단건 수행 완료 알림 - PLC : write_ready_state()
    {
        "name": "arm_place_single",
        # "browse_path": ["0:Objects", f"2:ARM", f"2:read_arm_place_single"],
        "browse_path": "ns=2;s=read_arm_place_single",
    ...
    #  # Place 전체 수행 완료 알림 - AMR : write_amr_go_positions("{"object_info" : "['esp32','motordriver','powersuplpy']"}")
    {
        ...
        # "browse_path": ["0:Objects", f"2:ARM", f"2:read_arm_place_completed"],
        "browse_path": "ns=2;s=read_arm_place_completed",
    ...
    # 3.장애물 혹은 에러로 인한 이동불가상태 - AMR : write_amr_go_move("go_home")
    {
        ...
        # "browse_path": ["0:Objects", f"2:AMR", f"2:read_amr_mission_state"],
        "browse_path": "ns=2;s=read_amr_mission_state",
